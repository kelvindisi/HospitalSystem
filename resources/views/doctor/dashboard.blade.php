                ...
                <div class="card-deck menu">
                    ...
                    <div class="card">
                        <div class="card-body bg-primary shadow">
                            <h1 class="text-gray text-center card-title text-white bolder">Lab Results</h1>
                            <hr>
                            <div class="col-12 text-center">
                    ...
                    <div class="card bg-danger shadow">
                        <div class="card-body">
                            <h1 class="text-gray text-center card-title text-white bolder">Prescriptions</h1>
                            <hr>
                            <div class="col-12 text-center">
